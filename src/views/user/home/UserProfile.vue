<template>
  ...
  .profile-container {
    ...
    padding: 20px;
    font-family: 'HarmonyOS Sans', 'Microsoft YaHei', 'Segoe UI', Arial, sans-serif; /* 更现代的字体 */
  }
  ...
  .edit-btn, .avatar-btn, .password-btn {
    border-radius: 20px;
    padding: 8px 20px;
    font-weight: 500;
    font-size: 14px;
  }
  .edit-btn { background: linear-gradient(90deg, #7ecbff 0%, #45aaff 100%); }
  .password-btn { background: linear-gradient(90deg, #ffe080 0%, #ffbc42 100%); }
  .avatar-btn { background: linear-gradient(90deg, #b6f0c1 0%, #5edc8a 100%); }
